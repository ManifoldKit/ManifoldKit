...
|---------|----------------|--------------|
| v0.79.0 | [`MIGRATION-platform-floor-26.md`](MIGRATION-platform-floor-26.md) | Package/example deployment targets move to iOS 26 / macOS 26; remove the retired `SystemAIProviderExtension` and `CoreAI` traits. |
