...
|---------|----------------|--------------|
| next | [`MIGRATION-skills-explicit-import.md`](MIGRATION-skills-explicit-import.md) | `ManifoldSkills` is no longer re-exported by `ManifoldKit`; add its product and import it explicitly. |
...
| next | [`MIGRATION-cloudbackenderror-missingRequiredOverride.md`](MIGRATION-cloudbackenderror-missingRequiredOverride.md) | `CloudBackendError` gains `missingRequiredOverride`; vocabulary declared "growth (1.x)", removed from the freeze-audit allowlist. |
