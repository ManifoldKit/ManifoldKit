...
Workflow: check out the release branch via its worktree, rewrite CHANGELOG.md, amend + force-push, then merge via `gh api -X PUT repos/ManifoldKit/ManifoldKit/pulls/<N>/merge -f merge_method=squash`.
