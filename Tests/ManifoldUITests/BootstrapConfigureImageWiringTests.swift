...
/// `ManifoldPersistenceSwiftDataTests` cannot import `ManifoldUI` (no `ChatViewModel`).
@MainActor
    ...
    private func makeBootstrap(
        ...
        return try ManifoldBootstrap(
            configuration: ManifoldConfiguration(
                ...
                bundleIdentifier: "com.manifoldkit.tests.bootstrap-configure-image-wiring.\(UUID().uuidString)"
            ),
