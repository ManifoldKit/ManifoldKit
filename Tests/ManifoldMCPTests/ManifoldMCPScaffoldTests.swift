...
final class ManifoldMCPScaffoldTests: XCTestCase {
    func test_serverDescriptorInitializes() {
        ...
        // Sabotage: removing the ManifoldMCP target from Package.swift would prevent `@testable import ManifoldMCP` from compiling, failing the test at build time; alternatively, removing the `displayName` property from MCPServerDescriptor would fail this XCTAssertEqual
