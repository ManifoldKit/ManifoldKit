...
/// surfaces for the first time in the merge queue — where it can also poison
/// other batched PRs. This test stays authoritative; if you change the
/// accepted `Audience:`/`Status:` values, the lookback window, the doc
/// set/exclusions, or the header regex shape here, update
