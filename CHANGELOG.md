...
* CompressionPolicy.shouldCompress(promptTokens:contextSize:) is now shouldCompress(promptTokens:contextSize:contextUtilization:).
* `BackendName.foundation` raw value flipped from `"Apple"` to `"foundation"` (and the other five cases similarly). Code that hardcoded the legacy strings (`if name == "Apple"`) breaks. Use `BackendName.<case>.rawValue` for new comparisons and `BackendName.parse(_:)` when reading already-persisted strings.
* **backends:** Consumers that imported BaseChatBackends keep compiling. Consumers that previously did `@testable import BaseChatBackends` to reach internals now need `@testable import BaseChat<Family>` (BaseChatMLX, BaseChatLlama, BaseChatCloud, BaseChatCloudCore, or BaseChatFoundation) for the family that owns the symbol. Five new library products (BaseChatCloudCore, BaseChatMLX, BaseChatLlama, BaseChatFoundation, BaseChatCloud) are publicly exposed alongside the umbrella.
* **runtime:** hosts that build ChatViewModel directly should pass conversationRuntime: at init when they want a specific runtime. Use BaseChatBootstrap for the default wiring; ad-hoc construction inherits an in-memory runtime that's swapped to the SwiftData-backed one when configure(persistence:) runs.
* **build:** `@ToolSchema` is no longer in the default build. Consumers using the macro must add `--traits Macros` to `swift build`/`swift test` invocations.
* **server:** BaseChatServer is no longer in the default build.
* make persistence and command APIs async throws (phase 1.0) ([#883](https://github.com/roryford/ManifoldKit/issues/883))
* ToolLoopEvent.loopDetected payload changed from String to ToolLoopFinding. Pattern matches on the case must be updated to extract `.toolName` from the finding.
* `ChatView` and `GenerationSettingsView` now require an `apiConfiguration:` `@ViewBuilder` closure (typically `{ APIConfigurationView() }` from the new module).

### Features

* add appData payload to TurnContext and CompletedTurn ([#1243](https://github.com/roryford/ManifoldKit/issues/1243)) ([25979f5](https://github.com/roryford/ManifoldKit/commit/25979f596f60c8d224aa9cd0ec058497e9aa1f6b))
...
* add diffusion download path to BaseChatHuggingFace ([#1018](https://github.com/roryford/ManifoldKit/issues/1018)) ([9bd6fce](https://github.com/roryford/ManifoldKit/commit/9bd6fcec6d47f3135693d591e1c750b27027d9f7))
* add fuzz calibration corpus and per-detector FP/TP gate ([#488](https://github.com/roryford/ManifoldKit/issues/488)) ([#837](https://github.com/roryford/ManifoldKit/issues/837)) ([a2f0c08](https://github.com/roryford/ManifoldKit/commit/a2f0c0862a21bc50660521f8332af69c9654166e))
* add HuggingFaceService.probe() connectivity check ([#1306](https://github.com/roryford/ManifoldKit/issues/1306)) ([40099b5](https://github.com/roryford/ManifoldKit/commit/40099b56a358acee6bab03296000ec2440d5a0d1))
* add image generation entry on ChatViewModel ([#1024](https://github.com/roryford/ManifoldKit/issues/1024)) ([008304e](https://github.com/roryford/ManifoldKit/commit/008304ee76462b33b34c7528459226cf5aa939b1))
* add image loading placeholders ([#1047](https://github.com/roryford/ManifoldKit/issues/1047)) ([ab5f506](https://github.com/roryford/ManifoldKit/commit/ab5f506fa3d4f22e0345d7021b8babf6a55a77d3))
* add image-model install UI in BaseChatUIModelManagement ([#1025](https://github.com/roryford/ManifoldKit/issues/1025)) ([27744e9](https://github.com/roryford/ManifoldKit/commit/27744e98edbccfce7be60058ed773e979e15857b))
* add ImageGenerationRuntime in BaseChatRuntime ([#1016](https://github.com/roryford/ManifoldKit/issues/1016)) ([c8adfe7](https://github.com/roryford/ManifoldKit/commit/c8adfe7afe2074b89eaa60b6218f489ab016fbb6))
* add ImageGenerationService for image-gen lifecycle ([#1008](https://github.com/roryford/ManifoldKit/issues/1008)) ([6ebeb73](https://github.com/roryford/ManifoldKit/commit/6ebeb734fa4f9ab7e265e0408564c9b333e6042f))
* add ImageModelInfo value type for image generation ([#1003](https://github.com/roryford/ManifoldKit/issues/1003)) ([f17083c](https://github.com/roryford/ManifoldKit/commit/f17083ca88d3a59f5252726cc258f7d9c020b803))
* add ImageModelLoadPlan for diffusion memory budgeting ([#1009](https://github.com/roryford/ManifoldKit/issues/1009)) ([d5c8f03](https://github.com/roryford/ManifoldKit/commit/d5c8f03a3b9947298f8ed487ec087c9af314d0ad))
* add isBuiltIn accessor on ModelInfo ([#1304](https://github.com/roryford/ManifoldKit/issues/1304)) ([ee36a39](https://github.com/roryford/ManifoldKit/commit/ee36a39f92acab5c21854275496494eb47c90ea8)), closes [#1297](https://github.com/roryford/ManifoldKit/issues/1297)
* add ManifoldConfiguration.networkPolicy host allowlist ([#1294](https://github.com/roryford/ManifoldKit/issues/1294)) ([5db6c80](https://github.com/roryford/ManifoldKit/commit/5db6c80795824b722f8a0ba9c006796095341750))
* add ManifoldMCPHost server-side MCP endpoint ([#1357](https://github.com/roryford/ManifoldKit/issues/1357)) ([2589818](https://github.com/roryford/ManifoldKit/commit/2589818992dea20ee7a7e61a4172f2283c5607c6))
* add MLXDiffusionBackend (first ImageGenerationBackend conformer) ([#1027](https://github.com/roryford/ManifoldKit/issues/1027)) ([7a61782](https://github.com/roryford/ManifoldKit/commit/7a61782665322be963b3b40b0830f8ddcc0fc4dd))
* add mmproj multimodal projector support to LlamaBackend ([#906](https://github.com/roryford/ManifoldKit/issues/906)) ([6a99a01](https://github.com/roryford/ManifoldKit/commit/6a99a01e82ebd58f7b92956bede982222138d86e))
* add model catalog sidecar ([#1167](https://github.com/roryford/ManifoldKit/issues/1167)) ([8bf626e](https://github.com/roryford/ManifoldKit/commit/8bf626e58a502aaab1b45c02a9e2edd0471f350f))
* add ModelLoadPlan.compute(for:requestedContextSize:) overload that picks strategy from ModelInfo ([#1099](https://github.com/roryford/ManifoldKit/issues/1099)) ([9192e61](https://github.com/roryford/ManifoldKit/commit/9192e615a9e6a6406c3f6f7758e1294f4c07bb38))
* add ModelLoadPlan.estimate for pre-download fit verdict ([#1305](https://github.com/roryford/ManifoldKit/issues/1305)) ([e3caa3f](https://github.com/roryford/ManifoldKit/commit/e3caa3f77368f85ea5e56b1f24e2caf00a778f40))
* add ModelRegistry.selectModel(_:) selection hook point ([#1312](https://github.com/roryford/ManifoldKit/issues/1312)) ([714fcb7](https://github.com/roryford/ManifoldKit/commit/714fcb7336e4f31e8cd6f4a678ae0a606c451c3a)), closes [#1303](https://github.com/roryford/ManifoldKit/issues/1303)
* add parallel fuzz workers ([#920](https://github.com/roryford/ManifoldKit/issues/920)) ([1059c3f](https://github.com/roryford/ManifoldKit/commit/1059c3f490a6b3a3756b7b233f7af6954394eb7a))
...
* add public MemoryPressureEvent stream on InferenceService ([#1295](https://github.com/roryford/ManifoldKit/issues/1295)) ([be37116](https://github.com/roryford/ManifoldKit/commit/be3711699550f80657148989130b76570777b710))
* add public NetworkActivity observable for HuggingFace traffic ([#1331](https://github.com/roryford/ManifoldKit/issues/1331)) ([4eb5be6](https://github.com/roryford/ManifoldKit/commit/4eb5be66fc7a8f4a40dd5d58c42cff18fc699ee9))
* add runtime bootstrap surface ([#866](https://github.com/roryford/ManifoldKit/issues/866)) ([9ec70c3](https://github.com/roryford/ManifoldKit/commit/9ec70c3b1483ac0158f7cc465035624bfd3913fb))
* add session-level pinning ([#1332](https://github.com/roryford/ManifoldKit/issues/1332)) ([aab6714](https://github.com/roryford/ManifoldKit/commit/aab671465900b3b7292c6674a87de02c86cbf2fc))
* add structured output strategy routing ([#1054](https://github.com/roryford/ManifoldKit/issues/1054)) ([ac17931](https://github.com/roryford/ManifoldKit/commit/ac17931291d14a1e842e48f8731181f189813058))
* add test-uplift control CLI ([#1127](https://github.com/roryford/ManifoldKit/issues/1127)) ([3f66236](https://github.com/roryford/ManifoldKit/commit/3f66236322f061b50522755206ffea1d1c27c28e))
* add tier-3 cold-start CI gate for ManifoldUI ChatView composition ([#1204](https://github.com/roryford/ManifoldKit/issues/1204)) ([dd19d48](https://github.com/roryford/ManifoldKit/commit/dd19d48372786f51767545dadeb283acf71933c0))
* add vision attachments to mlx chat flow ([c4cb638](https://github.com/roryford/ManifoldKit/commit/c4cb638f71af151e86248578536bc78f4660b96a))
* add willBeginTurn pre-turn hook to GenerationHook protocol ([#1244](https://github.com/roryford/ManifoldKit/issues/1244)) ([cb99eb6](https://github.com/roryford/ManifoldKit/commit/cb99eb6070050df919bace75765097f009f79ca1))
* adopt runtime bootstrap across UI examples ([#869](https://github.com/roryford/ManifoldKit/issues/869)) ([04fef18](https://github.com/roryford/ManifoldKit/commit/04fef18b59409808d1cf61b9b0a0172c5f6d4fbe))
* **agent-dx:** BackendName constants, loadFoundationModelIfAvailable, rm deprecated loadModel, docs ([#1114](https://github.com/roryford/ManifoldKit/issues/1114)) ([471fc7c](https://github.com/roryford/ManifoldKit/commit/471fc7ce536a1300b4a3d14b0b83e48fddae27a3))
* **agent-dx:** BackendName constants, loadFoundationModelIfAvailable, rm deprecated loadModel, docs ([#1131](https://github.com/roryford/ManifoldKit/issues/1131)) ([ae1493c](https://github.com/roryford/ManifoldKit/commit/ae1493c94fc1e78c94beceaa9337d51986674e52))
* **agent-dx:** scripted-driver ergonomics — sendMessage(_:), lastTurnState, per-app ModelStorageService ([#1111](https://github.com/roryford/ManifoldKit/issues/1111)) ([62238c7](https://github.com/roryford/ManifoldKit/commit/62238c75f565469472ee573dc718d203966aa2fe))
* App Intents seam — ChatSessionIntent for Siri and Spotlight integration ([#770](https://github.com/roryford/ManifoldKit/issues/770)) ([4456ee0](https://github.com/roryford/ManifoldKit/commit/4456ee065abb05747dd8ca80418d4a06c3e1c57a))
* **appintents:** AppIntent ↔ ToolDefinition bridge ([#798](https://github.com/roryford/ManifoldKit/issues/798)) ([bccafd8](https://github.com/roryford/ManifoldKit/commit/bccafd8abbd931bd28841454a221d3869165e16d))
* audit follow-ups — tool-spill action ([#846](https://github.com/roryford/ManifoldKit/issues/846)) + governance fixes ([#833](https://github.com/roryford/ManifoldKit/issues/833)) ([#859](https://github.com/roryford/ManifoldKit/issues/859)) ([45476a8](https://github.com/roryford/ManifoldKit/commit/45476a81fb139f0d5c397e352bdbc16f2cc9c99a))
* **backends:** add llama DRY sampler option ([#1031](https://github.com/roryford/ManifoldKit/issues/1031)) ([fe34220](https://github.com/roryford/ManifoldKit/commit/fe3422049d1bc7201968b56fb761f1373219931a))
* **backends:** add llama XTC and mirostat v2 sampler options ([#1037](https://github.com/roryford/ManifoldKit/issues/1037)) ([1ae9c54](https://github.com/roryford/ManifoldKit/commit/1ae9c545a8f8b931cd7d789fc8b30dd8505b0d4e))
* **backends:** introduce BackendRegistrar protocol and per-backend register hooks ([#794](https://github.com/roryford/ManifoldKit/issues/794)) ([94eecba](https://github.com/roryford/ManifoldKit/commit/94eecba0adde70bf951302c5a9f5d9297592c933))
* **backends:** reuse MLX KV cache prefixes across turns ([#814](https://github.com/roryford/ManifoldKit/issues/814)) ([7f6d8dd](https://github.com/roryford/ManifoldKit/commit/7f6d8ddc5402773f561a85ee8c12a78da42bf866))
* **backends:** split BaseChatBackends into 5 trait-gated products; delete cross-family stubs ([#1146](https://github.com/roryford/ManifoldKit/issues/1146)) ([1d1bdbb](https://github.com/roryford/ManifoldKit/commit/1d1bdbb012da0f0d7f1cc9a14b3b57d8c6b2eb55))
* BaseChatKit umbrella product; BackendName enum with raw-value flip ("Apple" → "foundation") ([#1147](https://github.com/roryford/ManifoldKit/issues/1147)) ([69fcc1f](https://github.com/roryford/ManifoldKit/commit/69fcc1fec8b212cbf467ed6ce470d2f290e4da67))
...
* **claude:** image content blocks for vision models ([#944](https://github.com/roryford/ManifoldKit/issues/944)) ([f1fe29b](https://github.com/roryford/ManifoldKit/commit/f1fe29b9b055b397df044691fe63df83c33c83b9))
* **cloud:** preserve thinking blocks across multi-turn Claude requests ([#776](https://github.com/roryford/ManifoldKit/issues/776)) ([6f04e7a](https://github.com/roryford/ManifoldKit/commit/6f04e7a8be19abf5ce1f2efed3b9e7ff6eb25776)), closes [#604](https://github.com/roryford/ManifoldKit/issues/604) [#482](https://github.com/roryford/ManifoldKit/issues/482)
...
* **cloud:** tool calling on OpenAI / Claude / Ollama backends ([#789](https://github.com/roryford/ManifoldKit/issues/789)) ([79bb84e](https://github.com/roryford/ManifoldKit/commit/79bb84ed151e6428dafb30a9743dbe89f71a8fe3))
* complete MCP rollout full coverage ([#790](https://github.com/roryford/ManifoldKit/issues/790)) ([896d316](https://github.com/roryford/ManifoldKit/commit/896d316e9165bb2277216d5420900f536074025f))
* **core:** BackgroundTaskScheduler protocol + iOS BGTaskScheduler impl ([#829](https://github.com/roryford/ManifoldKit/issues/829)) ([979b887](https://github.com/roryford/ManifoldKit/commit/979b887965615b748c2d97a36d9466ffbec03cf3))
* **core:** ConversationExportFormat protocol with markdown + JSONL ([#820](https://github.com/roryford/ManifoldKit/issues/820)) ([08a31be](https://github.com/roryford/ManifoldKit/commit/08a31be552584b513cd6e926b0fe3289084d2dea))
* deleteAllSessions() atomic bulk-delete API ([#1325](https://github.com/roryford/ManifoldKit/issues/1325)) ([b14c570](https://github.com/roryford/ManifoldKit/commit/b14c5706e1ab38255be48e582552846a6face63d)), closes [#1300](https://github.com/roryford/ManifoldKit/issues/1300)
* **demo:** add Demo Scenarios picker with three-layer test pattern ([#710](https://github.com/roryford/ManifoldKit/issues/710)) ([c804504](https://github.com/roryford/ManifoldKit/commit/c804504f19de10050f12763f8ce2dcb802cc1282))
* **demo:** ship working MCP server and tool-calling-via-MCP scenario ([#934](https://github.com/roryford/ManifoldKit/issues/934)) ([23e52d0](https://github.com/roryford/ManifoldKit/commit/23e52d0728b3e91380a06fad102b08b1d005afe2))
* **demo:** tool-call error scenarios — invalid args, rate-limit retry, MCP failure ([#850](https://github.com/roryford/ManifoldKit/issues/850)) ([a089b0c](https://github.com/roryford/ManifoldKit/commit/a089b0c80f803558a64f51d88fa207f3c357cceb))
...
* enrich server models response ([#1169](https://github.com/roryford/ManifoldKit/issues/1169)) ([0933e1c](https://github.com/roryford/ManifoldKit/commit/0933e1ccccf2948332a966ab436068af1b2bc059))
* **example:** register basechatdemo URL scheme + attachments envelope ([#799](https://github.com/roryford/ManifoldKit/issues/799)) ([f9a51e9](https://github.com/roryford/ManifoldKit/commit/f9a51e9d05eec4ef97791017af2c3920af6fcd83))
* **example:** Share + Action Extension recipes (App Group handoff) ([#840](https://github.com/roryford/ManifoldKit/issues/840)) ([a91744e](https://github.com/roryford/ManifoldKit/commit/a91744e16305b9afe156622816b86f4cb27ca4d2))
* expose compiled backend build profiles ([#867](https://github.com/roryford/ManifoldKit/issues/867)) ([8d16dc2](https://github.com/roryford/ManifoldKit/commit/8d16dc247ea82c30bc272fa3ca18af063c6dea76))
* extend ModelCapabilities with codeGeneration and multilingual axes ([#1330](https://github.com/roryford/ManifoldKit/issues/1330)) ([c156ccc](https://github.com/roryford/ManifoldKit/commit/c156ccc84c31d85094968b234c5826e1db64e440))
* flip default backend load options ([#1046](https://github.com/roryford/ManifoldKit/issues/1046)) ([63ba72a](https://github.com/roryford/ManifoldKit/commit/63ba72abb6ced645ce63f630ae4b5c388eb87da5))
...
* FoundationOnly trait, PrivacyInfo template, App Store submission checklist ([#1139](https://github.com/roryford/ManifoldKit/issues/1139)) ([7962f07](https://github.com/roryford/ManifoldKit/commit/7962f0771ae581efefcee3eef00a32be4b29a221))
* **foundation:** tool calling via Generable / GuidedGeneration ([#812](https://github.com/roryford/ManifoldKit/issues/812)) ([e5bfedd](https://github.com/roryford/ManifoldKit/commit/e5bfedd3e05ab3f0ddec6d0a4e9ec8d5c920df03))
* **fuzz:** ToolCallValidityDetector — invariant checks for tool-call correctness ([#813](https://github.com/roryford/ManifoldKit/issues/813)) ([0e74123](https://github.com/roryford/ManifoldKit/commit/0e741234b98ed3ff4ec1d17473a1df61cfae5b0c))
...
* harden MCP platform callbacks ([#1168](https://github.com/roryford/ManifoldKit/issues/1168)) ([23f1643](https://github.com/roryford/ManifoldKit/commit/23f164367465ba007473ca9f91809ec0ec71cf6a))
...
* **hf:** auto-detect .fp16.safetensors variants in diffusion downloader ([#1327](https://github.com/roryford/ManifoldKit/issues/1327)) ([15cd93b](https://github.com/roryford/ManifoldKit/commit/15cd93b423fffc0aeb76fc9bef94cefeb69caf6d)), closes [#1316](https://github.com/roryford/ManifoldKit/issues/1316)
* HistoryAssembly stage for pre-generation record injection ([2acdd46](https://github.com/roryford/ManifoldKit/commit/2acdd46c50dbd4794f7bd6be692b0be87b62b164))
* historyCompressed event carries insertedRecords + CompressionPolicy.postCompress ([#1245](https://github.com/roryford/ManifoldKit/issues/1245)) ([ed45267](https://github.com/roryford/ManifoldKit/commit/ed45267ecbac37adaf670951d0656414d54dff5b))
* **huggingface:** support multi-component packages ([#1053](https://github.com/roryford/ManifoldKit/issues/1053)) ([91d3da9](https://github.com/roryford/ManifoldKit/commit/91d3da941c4845436fa649a3ed5ff8ef5e12bcb6))
* improve architecture boundaries and capability contracts ([#1060](https://github.com/roryford/ManifoldKit/issues/1060)) ([0501b0d](https://github.com/roryford/ManifoldKit/commit/0501b0d59cf25abc173d305d879e175cfaaf2337))
* **inference:** add minP, repetitionPenalty, seed for mlx-swift-lm parity ([#773](https://github.com/roryford/ManifoldKit/issues/773)) ([bd59e9b](https://github.com/roryford/ManifoldKit/commit/bd59e9b0640277b876ef78e29766a25036207ead)), closes [#750](https://github.com/roryford/ManifoldKit/issues/750)
* **inference:** BackendLoadOptions for KV quant, Flash Attention, prefill batch ([#1026](https://github.com/roryford/ManifoldKit/issues/1026)) ([9bf8034](https://github.com/roryford/ManifoldKit/commit/9bf8034aee266edccbcf0f658b4209f010b8b13e))
* **inference:** cancellation contract for in-flight tool execution ([#775](https://github.com/roryford/ManifoldKit/issues/775)) ([4d618a9](https://github.com/roryford/ManifoldKit/commit/4d618a9bb275295e29474be3ca62139c0b2b47fd)), closes [#622](https://github.com/roryford/ManifoldKit/issues/622)
* **inference:** capability routing — per-request capability requirements + RouterBackend ([#810](https://github.com/roryford/ManifoldKit/issues/810)) ([99d8835](https://github.com/roryford/ManifoldKit/commit/99d8835f45e667eace6e07108909e50eecfed2ff))
* **inference:** heal orphan tool calls on session reload ([#774](https://github.com/roryford/ManifoldKit/issues/774)) ([f11d993](https://github.com/roryford/ManifoldKit/commit/f11d99350d8fbfa0ccf2db8ea76899e3171c6345)), closes [#629](https://github.com/roryford/ManifoldKit/issues/629)
* **inference:** ImageGenerationBackend protocol + image message persistence ([#992](https://github.com/roryford/ManifoldKit/issues/992)) ([041ca16](https://github.com/roryford/ManifoldKit/commit/041ca16094e538f71da21b874d8c7e2d982e1b75))
* **inference:** ModelInfo factory for HuggingFace-sourced models ([#981](https://github.com/roryford/ManifoldKit/issues/981)) ([36fa889](https://github.com/roryford/ManifoldKit/commit/36fa889db81d691b076fca07876769b42e647998)), closes [#975](https://github.com/roryford/ManifoldKit/issues/975)
* **inference:** pause generation when ProcessInfo.thermalState reaches .critical ([#764](https://github.com/roryford/ManifoldKit/issues/764)) ([12149ad](https://github.com/roryford/ManifoldKit/commit/12149ad5090489a5edbd8af66e06bed8e26b00e9))
* **inference:** per-generation sampler knobs + topK consumption fix ([#1022](https://github.com/roryford/ManifoldKit/issues/1022)) ([89bcefc](https://github.com/roryford/ManifoldKit/commit/89bcefcc0538232d5bda898508a6007cb42b55a2))
* **inference:** probe HF config.json for vision/audio capability before loading ([#762](https://github.com/roryford/ManifoldKit/issues/762)) ([523c690](https://github.com/roryford/ManifoldKit/commit/523c6905d81dbedf70d38a9755ef6cceadfc997e))
* **inference:** represent parallel tool-call batches in GenerationEvent ([#783](https://github.com/roryford/ManifoldKit/issues/783)) ([8a7d2e7](https://github.com/roryford/ManifoldKit/commit/8a7d2e710b0b7482b77d532365342b83b2c25ecd))
* **inference:** tool-call loop orchestrator, output size policy, registry reentrancy contract ([#779](https://github.com/roryford/ManifoldKit/issues/779)) ([db83476](https://github.com/roryford/ManifoldKit/commit/db83476c42ab478391ecf9c52b63565cebbbf10a))
* **inference:** turn-history compression for agent-loop transcripts ([#811](https://github.com/roryford/ManifoldKit/issues/811)) ([4b39547](https://github.com/roryford/ManifoldKit/commit/4b39547bc80bdabc753d20aa4a4d3caf3e43248a))
* **inference:** typed PromptSlot roles for priority-aware budget allocation ([#819](https://github.com/roryford/ManifoldKit/issues/819)) ([db9eff2](https://github.com/roryford/ManifoldKit/commit/db9eff22d7e99b12dcbdada9f388f437ba958ee4))
* **inference:** typed tool-dispatch lifecycle events ([#849](https://github.com/roryford/ManifoldKit/issues/849)) ([bfd7a44](https://github.com/roryford/ManifoldKit/commit/bfd7a44a92dfea449d27b8d45033678abb93c285))
...
* llama XTC + Mirostat V2 samplers and structured output routing ([#1061](https://github.com/roryford/ManifoldKit/issues/1061)) ([f39b5cd](https://github.com/roryford/ManifoldKit/commit/f39b5cd9ecfad4c2932aaf98835a3841c0284577))
* **llama:** Gemma 4 tool calling + GBNF schema pre-validator ([#414](https://github.com/roryford/ManifoldKit/issues/414), [#609](https://github.com/roryford/ManifoldKit/issues/609)) ([#836](https://github.com/roryford/ManifoldKit/issues/836)) ([677ed25](https://github.com/roryford/ManifoldKit/commit/677ed2503b3f4ce18fa8231da61faa775d3d70d7))
* **mcp:** add v1.1 follow-up polish ([#940](https://github.com/roryford/ManifoldKit/issues/940)) ([94d622e](https://github.com/roryford/ManifoldKit/commit/94d622e88201d7f965ff3e1a16f73a72e78cb299))
* **mcp:** enforce Foundation Models tool cap + settings UI counter ([#1354](https://github.com/roryford/ManifoldKit/issues/1354)) ([7d9e780](https://github.com/roryford/ManifoldKit/commit/7d9e780b90af8ed50b97e867248b6a30a7729419)), closes [#792](https://github.com/roryford/ManifoldKit/issues/792)
* **mcp:** Foundation Models tool cap + schema filter ([#797](https://github.com/roryford/ManifoldKit/issues/797)) ([6516d61](https://github.com/roryford/ManifoldKit/commit/6516d61e41f05241f21027e93eefc6f9ea316d0e))
* **mcp:** map MCPError to ToolResult.ErrorKind ([#848](https://github.com/roryford/ManifoldKit/issues/848)) ([7fa47cf](https://github.com/roryford/ManifoldKit/commit/7fa47cfbd06637118c88804699d615eb191b8e17))
* MessageKind axis + wire-contract overhaul ([a285baf](https://github.com/roryford/ManifoldKit/commit/a285baf6a17669a50677164143a4268b2bfa3c0b))
* **mlx:** route MoE Gemma 4 through MLXVLM factory ([#769](https://github.com/roryford/ManifoldKit/issues/769)) ([5710c76](https://github.com/roryford/ManifoldKit/commit/5710c76a9c5fc834048e27c924e7d50b2fd045c6))
* **mlx:** support Gemma 4 + namespaced MLX model layouts ([#742](https://github.com/roryford/ManifoldKit/issues/742)) ([c968d24](https://github.com/roryford/ManifoldKit/commit/c968d24986afb19844425f635393260076d61d3e))
* **mlx:** tool calling support + local backend docs + Foundation tracking ([#725](https://github.com/roryford/ManifoldKit/issues/725)) ([ab2a7dd](https://github.com/roryford/ManifoldKit/commit/ab2a7ddcd7737bead8c1e10a623e7653a2134376))
* model selection sort + TTFT perf test SIGTRAP fix ([#879](https://github.com/roryford/ManifoldKit/issues/879)) ([b5ebbd7](https://github.com/roryford/ManifoldKit/commit/b5ebbd7c52a7024bc54ad01e29881a3257cc1774))
* **openai:** forward prefill_progress SSE events from compatible upstream servers ([#804](https://github.com/roryford/ManifoldKit/issues/804)) ([8555e58](https://github.com/roryford/ManifoldKit/commit/8555e58b57ca5a03f502c057a327828a746fc7ad))
* **openai:** image_url content parts for vision models ([#960](https://github.com/roryford/ManifoldKit/issues/960)) ([4150c5d](https://github.com/roryford/ManifoldKit/commit/4150c5dee19e05a1b82e4ce42657c44761dab3c9))
* peel BaseChatUIModelManagement; drop Ollama from default traits ([#796](https://github.com/roryford/ManifoldKit/issues/796)) ([1754550](https://github.com/roryford/ManifoldKit/commit/1754550144a3127ed2066d6b6f1507a6e6740781))
* persist MCP disclosure consent ([#1170](https://github.com/roryford/ManifoldKit/issues/1170)) ([4f97445](https://github.com/roryford/ManifoldKit/commit/4f97445358b41f19cdaea3f0e5f9128772a55331))
* **persistence:** persist sampler preset penalty knobs ([#1033](https://github.com/roryford/ManifoldKit/issues/1033)) ([c7ff806](https://github.com/roryford/ManifoldKit/commit/c7ff806b01c6bfa9afc359857db71ab5d75a6e42))
* Phase 5 — delete deprecated cloud helpers + AuditSabotageSuite ([#1290](https://github.com/roryford/ManifoldKit/issues/1290)) ([4c145f4](https://github.com/roryford/ManifoldKit/commit/4c145f44dd9c28ef3f30301537ddb639b10f60af))
* port Goose AI Tier 1 patterns to BCK ([#852](https://github.com/roryford/ManifoldKit/issues/852)) ([3cfd982](https://github.com/roryford/ManifoldKit/commit/3cfd982bede1a9347d66329c5935df75946f7a6e))
* public stagedAttachments API on ChatViewModel ([#1326](https://github.com/roryford/ManifoldKit/issues/1326)) ([2fac21d](https://github.com/roryford/ManifoldKit/commit/2fac21d96558b2f27902ef0c0946d23eb6b4a582)), closes [#1302](https://github.com/roryford/ManifoldKit/issues/1302)
* RAG phase 2 — sentence-boundary chunker + /v1/embeddings endpoint ([#1356](https://github.com/roryford/ManifoldKit/issues/1356)) ([b289199](https://github.com/roryford/ManifoldKit/commit/b2891991a997604d8ac818680d011ec8d867d844))
* **rag:** add RAG knowledge base — document ingestion, vector store, retrieval-augmented context ([b9c00a4](https://github.com/roryford/ManifoldKit/commit/b9c00a4c09f1785637efbfbaf442f6a0489d6abe))
...
* rename BaseChatKit → ManifoldKit (v0.20) ([#1150](https://github.com/roryford/ManifoldKit/issues/1150)) ([8a785ee](https://github.com/roryford/ManifoldKit/commit/8a785eec8b7cc84ab65be2f4e910ec5417c9dd45))
* **runtime:** add bootstrap milestone stream ([#909](https://github.com/roryford/ManifoldKit/issues/909)) ([b116c5b](https://github.com/roryford/ManifoldKit/commit/b116c5ba30ca2b281a3954223942d2607ce0b176))
...
* **runtime:** collapse TurnInput, typed SendMessageError, configure(bootstrap:), enqueue([Message]) ([#1145](https://github.com/roryford/ManifoldKit/issues/1145)) ([df75435](https://github.com/roryford/ManifoldKit/commit/df754357a45ecd22229ac2e4450c82595483b4c9))
* **runtime:** ConversationRuntime is the canonical turn-loop orchestrator ([#947](https://github.com/roryford/ManifoldKit/issues/947)) ([#963](https://github.com/roryford/ManifoldKit/issues/963)) ([19f6cbe](https://github.com/roryford/ManifoldKit/commit/19f6cbe5482ff058da80c0c2fe188071fd429c0c))
* **runtime:** relocate MessageStore, SessionStore, persistence-port types to BaseChatRuntime ([#1140](https://github.com/roryford/ManifoldKit/issues/1140)) ([af5f52d](https://github.com/roryford/ManifoldKit/commit/af5f52d6f9833db9fa50798f997d8410a6c635f8))
...
* **security:** Phase 5 security hardening — SecureBytes, KV-cache wipe, SecureEnclave ([#907](https://github.com/roryford/ManifoldKit/issues/907)) ([2cef706](https://github.com/roryford/ManifoldKit/commit/2cef7060c25af8dda65e7528a7c265faba8ef951))
* **security:** SHA-256 verification for downloaded weights (Phase 1 of [#367](https://github.com/roryford/ManifoldKit/issues/367)) ([#978](https://github.com/roryford/ManifoldKit/issues/978)) ([e4d0c43](https://github.com/roryford/ManifoldKit/commit/e4d0c43ef85a579bf55e1f915426272dcaf0f646))
* **server:** add /v1/embeddings endpoint ([#1355](https://github.com/roryford/ManifoldKit/issues/1355)) ([59bdece](https://github.com/roryford/ManifoldKit/commit/59bdece442fccb3ddbfe23cce368aef42eb31266))
* **server:** add OpenAI-compatible BaseChatServer ([64f1d57](https://github.com/roryford/ManifoldKit/commit/64f1d5750708ddb52153554ffc6ef2d96710d5bc)), closes [#744](https://github.com/roryford/ManifoldKit/issues/744)
* **server:** add RequestAuthMiddleware abstraction with bearer-token impl ([#994](https://github.com/roryford/ManifoldKit/issues/994)) ([8a776e1](https://github.com/roryford/ManifoldKit/commit/8a776e17b96d00583d5009f43bd704b7971c04cf)), closes [#976](https://github.com/roryford/ManifoldKit/issues/976)
* **server:** trait-gate BaseChatServer + add Package.resolved budget guardrail ([#946](https://github.com/roryford/ManifoldKit/issues/946)) ([2cdb709](https://github.com/roryford/ManifoldKit/commit/2cdb709dde2c890127472ff18e40af22bb2a2d14))
* smooth BYO UI integration ([#1128](https://github.com/roryford/ManifoldKit/issues/1128)) ([ac5476c](https://github.com/roryford/ManifoldKit/commit/ac5476cb803ebed14a25748c3618c17055593399))
* **test-infra:** cross-backend Phase 1a — baseline gates + fixture comparator ([#1246](https://github.com/roryford/ManifoldKit/issues/1246)) ([f8c6bf0](https://github.com/roryford/ManifoldKit/commit/f8c6bf032d4f35287317c0c9869b817ce5719716))
* **test:** add Package.swift hygiene + #if trait sanity audit rules (Phase 2B of [#714](https://github.com/roryford/ManifoldKit/issues/714)) ([#740](https://github.com/roryford/ManifoldKit/issues/740)) ([008e0f9](https://github.com/roryford/ManifoldKit/commit/008e0f92145fc2c2775f23750a7bce438544b8a8))
* thinking cross-cutting bundle — OpenAI Responses, Jinja marker discovery, MockMLX hooks ([#780](https://github.com/roryford/ManifoldKit/issues/780)) ([d5ce21f](https://github.com/roryford/ManifoldKit/commit/d5ce21f9f1aa324db7e711ff96cc10796235003f))
* trait-gate HuggingFace support and add AnyLanguageModel bridge ([#896](https://github.com/roryford/ManifoldKit/issues/896)) ([f0d7cd0](https://github.com/roryford/ManifoldKit/commit/f0d7cd0961483f709a05798a9bc8897cbaace381))
...
* **ui:** add audio message playback ([#1052](https://github.com/roryford/ManifoldKit/issues/1052)) ([f1e474c](https://github.com/roryford/ManifoldKit/commit/f1e474c1c4242b68623e8bb62196e165ca6897aa))
* **ui:** add link preview provider seam ([#1034](https://github.com/roryford/ManifoldKit/issues/1034)) ([600fad2](https://github.com/roryford/ManifoldKit/commit/600fad2bd3e086b26ac7c69e63d818c4eb5bf1d6))
* **ui:** add message context menu with copy/regenerate/branch/delete ([#1039](https://github.com/roryford/ManifoldKit/issues/1039)) ([e199cad](https://github.com/roryford/ManifoldKit/commit/e199cad1f25fde5b41b40a8849a1c8b82cc96706))
* **ui:** add scroll-to-message request API ([#1030](https://github.com/roryford/ManifoldKit/issues/1030)) ([58947e9](https://github.com/roryford/ManifoldKit/commit/58947e95d97241e4cfd3d9d41fb11f9acba2ca0f))
* **ui:** add session list search, filtering, and pagination ([#778](https://github.com/roryford/ManifoldKit/issues/778)) ([b88652a](https://github.com/roryford/ManifoldKit/commit/b88652a4aa8cf92c608805a29b6aa44c4f149226))
* **ui:** ChatViewModel.ingestPendingPayload API for extension-driven sessions ([#763](https://github.com/roryford/ManifoldKit/issues/763)) ([6bf074f](https://github.com/roryford/ManifoldKit/commit/6bf074fe556c2ba7a20596a45d3d2f67c12523ea))
* **ui:** live streaming display for thinking tokens ([#767](https://github.com/roryford/ManifoldKit/issues/767)) ([75147de](https://github.com/roryford/ManifoldKit/commit/75147ded461d624245cdb005a53fe2dce8f2ae9a))
* verify model checksums when available ([#924](https://github.com/roryford/ManifoldKit/issues/924)) ([73c5af2](https://github.com/roryford/ManifoldKit/commit/73c5af24e4ca672193415ea727d1641c6c53fcf6))
* **voice:** add BaseChatVoice speech I/O module ([#887](https://github.com/roryford/ManifoldKit/issues/887)) ([f512b4e](https://github.com/roryford/ManifoldKit/commit/f512b4e5b0785c138624f87a02a08c45c9837c7b))
* wire GGUF manifest verification into download flow ([#1353](https://github.com/roryford/ManifoldKit/issues/1353)) ([bfa0761](https://github.com/roryford/ManifoldKit/commit/bfa0761d04203bd825d63724caa1c4344d7f0eca))
* wire image generation stack into BaseChatBootstrap ([#1028](https://github.com/roryford/ManifoldKit/issues/1028)) ([75c93a0](https://github.com/roryford/ManifoldKit/commit/75c93a02a4728451642065896de0922bbda560de))


### Bug Fixes

* add curated model checksum audit test and unverified UI indicator ([#1250](https://github.com/roryford/ManifoldKit/issues/1250)) ([9074dc3](https://github.com/roryford/ManifoldKit/commit/9074dc33b5784af8f7cd2944c9c54bcd3f9df0d8))
...
* align fuzz backend configuration ([#857](https://github.com/roryford/ManifoldKit/issues/857)) ([b7d6964](https://github.com/roryford/ManifoldKit/commit/b7d69641c99f6f0613278b0bf6aebd08881e9603))
* **backends:** MLXResourceArbiter for per-instance cache accounting; ToolArgumentCoercer recurses into nested schemas ([#1144](https://github.com/roryford/ManifoldKit/issues/1144)) ([2c4e3fc](https://github.com/roryford/ManifoldKit/commit/2c4e3fc7601224a569b4d32bf47ca5d8f6bc43db))
* **backends:** OllamaBackend.processToolCalls honors mid-line cancellation ([#995](https://github.com/roryford/ManifoldKit/issues/995)) ([b905a9b](https://github.com/roryford/ManifoldKit/commit/b905a9b19b9e5193d731621b3821154af857d27d))
* **build:** trait-gate BaseChatServer's BaseChatBackends dep to fix xcodebuild scheme conflict ([#983](https://github.com/roryford/ManifoldKit/issues/983)) ([29c0442](https://github.com/roryford/ManifoldKit/commit/29c0442b8553a8c6c622fb50fae98c839d4f823f))
* **build:** wrapper script for MLX integration tests with env passthrough ([#991](https://github.com/roryford/ManifoldKit/issues/991)) ([8483083](https://github.com/roryford/ManifoldKit/commit/8483083b288a3b8a7900823e2c40adff5945d42b))
* CI step timeouts + pre-existing test failures after security hardening ([b659f6f](https://github.com/roryford/ManifoldKit/commit/b659f6f234e622554998b0f775d1d826ac93bfd1))
* **ci:** annotate README install pins for release-please auto-bump ([#1324](https://github.com/roryford/ManifoldKit/issues/1324)) ([457b3b8](https://github.com/roryford/ManifoldKit/commit/457b3b8a0e58ba3e66c873713fc0fe33da1b41b7))
* **ci:** eliminate post-merge main-branch CI flakes ([#761](https://github.com/roryford/ManifoldKit/issues/761)) ([7fe6b02](https://github.com/roryford/ManifoldKit/commit/7fe6b024acfc4ace911e089d0e71649af8bd1465))
* **ci:** make check-coverage.sh work on bash 3.2 ([#1323](https://github.com/roryford/ManifoldKit/issues/1323)) ([43ed199](https://github.com/roryford/ManifoldKit/commit/43ed1990740c086b826a8a42646a45dd4ef89885))
* **ci:** trigger CI on changes to scripts/cold-start*.sh ([#1103](https://github.com/roryford/ManifoldKit/issues/1103)) ([08a341a](https://github.com/roryford/ManifoldKit/commit/08a341ac6902ebecc871a82cdc11ba0c504396ac))
...
* close Foundation multimodal support gap ([#1050](https://github.com/roryford/ManifoldKit/issues/1050)) ([99ea4ef](https://github.com/roryford/ManifoldKit/commit/99ea4ef3b8fbb53648ff9d7bc53b26cab1317922))
...
* **cloud:** gate CloudSaaS-only types behind #if CloudSaaS in Ollama-only builds ([2a36a3e](https://github.com/roryford/ManifoldKit/commit/2a36a3e28742cec2921ad454d9a9d289ef00d699))
* deflake MockBackendLifecycleTests.test_backToBackMakeStream_clearsTaskBetweenRuns ([#1333](https://github.com/roryford/ManifoldKit/issues/1333)) ([68a7622](https://github.com/roryford/ManifoldKit/commit/68a7622b73255686fc0bcc87861cc64f2b22f777)), closes [#1329](https://github.com/roryford/ManifoldKit/issues/1329)
* derive default SwiftData store path from bundle identifier ([#1100](https://github.com/roryford/ManifoldKit/issues/1100)) ([0a4cb6e](https://github.com/roryford/ManifoldKit/commit/0a4cb6e7dcc93bd0b7512c90e47b837885b1f18b))
...
* enforce input size bounds on user messages, RAG queries, MCP tool metadata, and server request bodies ([#1256](https://github.com/roryford/ManifoldKit/issues/1256)) ([4e8e9c1](https://github.com/roryford/ManifoldKit/commit/4e8e9c1e4ebfd4501e1bce45d8752673b7e46cc7))
* enforce kSecAttrAccessible on Keychain update and propagate delete errors ([#1252](https://github.com/roryford/ManifoldKit/issues/1252)) ([fbbca25](https://github.com/roryford/ManifoldKit/commit/fbbca25d60e34f93dd77defe3326da31bb8fe786))
...
* fail closed for unsupported cloud grammars ([5afd8fc](https://github.com/roryford/ManifoldKit/commit/5afd8fc46c62c9288e1e18a3c2a11b16a3be61b5))
* fail closed for unsupported grammar ([#1122](https://github.com/roryford/ManifoldKit/issues/1122)) ([9569537](https://github.com/roryford/ManifoldKit/commit/956953710bf41e417f2332560091e90250bb205a))
* **foundation:** wire maximumResponseTokens, greedy sampling, and prewarm ([#1180](https://github.com/roryford/ManifoldKit/issues/1180)) ([759cacf](https://github.com/roryford/ManifoldKit/commit/759cacf1cde1fba83c1a1dbe31d78f20f164abba))
* **fuzz:** Ollama trait gap + empty-arg expansion + thinking-loop guard ([#844](https://github.com/roryford/ManifoldKit/issues/844)) ([d690e18](https://github.com/roryford/ManifoldKit/commit/d690e1899e23764150cc37d0d102b2849c8494de))
* gate Ollama contract tests on #if Ollama + restore Package.resolved ([fa3a10f](https://github.com/roryford/ManifoldKit/commit/fa3a10f80f081eb61c42cdc22ecc0fedc44dd912))
* gate streaming usage chunks ([4443f40](https://github.com/roryford/ManifoldKit/commit/4443f40383bade65bac7a40f62fb609201f07098))
* guard BaseChatVoice in simulator and refresh post-split docs ([#931](https://github.com/roryford/ManifoldKit/issues/931)) ([bfd67b9](https://github.com/roryford/ManifoldKit/commit/bfd67b9e824dc2138f725f0924d65b5c62718fbd))
...
* **inference:** auto-drain queue on stream termination, deprecate generationDidFinish() ([#781](https://github.com/roryford/ManifoldKit/issues/781)) ([4a6174f](https://github.com/roryford/ManifoldKit/commit/4a6174f60fcdcea822f20f52a27c557658c5d7b3))
* **inference:** introduce ModelManifest, derive backend capabilities + per-model wire fields ([#1141](https://github.com/roryford/ManifoldKit/issues/1141)) ([250e71d](https://github.com/roryford/ManifoldKit/commit/250e71df87d7b78d74205cb0266aee9c32c6a5d8))
* **inference:** reject GGUF files without magic-bytes header in discovery ([#723](https://github.com/roryford/ManifoldKit/issues/723)) ([b0108ed](https://github.com/roryford/ManifoldKit/commit/b0108ed3cb5fe4a83bdf57eea7c57f8b41a48da9))
* limit clipboard sync for copied chat text ([#922](https://github.com/roryford/ManifoldKit/issues/922)) ([3ec9e88](https://github.com/roryford/ManifoldKit/commit/3ec9e88639a6c8d9d05e5a656e20d272c9598d92))
* **llama:** env-gate the n_gpu_layers=0 TEMP in LlamaModelLoader ([#938](https://github.com/roryford/ManifoldKit/issues/938)) ([15a8362](https://github.com/roryford/ManifoldKit/commit/15a83625f5ad8d1eaf0970c3e45fc3a7f0fee6cc))
* **llama:** re-decode last 2 tokens batched in KV-reuse turn to match Metal kernel path ([#985](https://github.com/roryford/ManifoldKit/issues/985)) ([1ecb291](https://github.com/roryford/ManifoldKit/commit/1ecb291bb54f5fb5403d02403c6536b05e942fb5))
* **llama:** separate thinking/visible budgets + greedy sampler at temperature=0 ([#1171](https://github.com/roryford/ManifoldKit/issues/1171)) ([78d528a](https://github.com/roryford/ManifoldKit/commit/78d528a0a83099e24e540b8414bfafb8579931c1))
...
* make MCPPersistentToolApprovalStore actually persistent via UserDefaults ([#1257](https://github.com/roryford/ManifoldKit/issues/1257)) ([b2240c0](https://github.com/roryford/ManifoldKit/commit/b2240c0d15c19f4e6b729d981136e0007e3cfac4))
...
* MCPToolSource @MainActor close, bounded event stream, throwing CSPRNG, and Sendable documentation ([#1253](https://github.com/roryford/ManifoldKit/issues/1253)) ([af09190](https://github.com/roryford/ManifoldKit/commit/af09190c402e79e80ce71512240bdc8be9a6f550))
* **mlx:** convert Gemma4 MoE fatalError to thrown InferenceError ([#1055](https://github.com/roryford/ManifoldKit/issues/1055)) ([a19e553](https://github.com/roryford/ManifoldKit/commit/a19e553ad1c85a35cf8f59832965b5c107b17eec)), closes [#802](https://github.com/roryford/ManifoldKit/issues/802)
* **mlx:** skip Gemma4 MoE inference test pending upstream broadcast fix ([#835](https://github.com/roryford/ManifoldKit/issues/835)) ([54839e9](https://github.com/roryford/ManifoldKit/commit/54839e95dcc5532104dd3cf6151b2d2b5dc2f9ee)), closes [#802](https://github.com/roryford/ManifoldKit/issues/802)
* network security hardening — TLS floor, SSRF lock, CGNAT range, scheme guard, log annotations ([#1254](https://github.com/roryford/ManifoldKit/issues/1254)) ([8ed4c64](https://github.com/roryford/ManifoldKit/commit/8ed4c64237a3bf4cbb135efbc0282f7118c02997))
* **openai:** exclude jsonMode from Codable and add Ollama format key ([#900](https://github.com/roryford/ManifoldKit/issues/900)) ([30ad75f](https://github.com/roryford/ManifoldKit/commit/30ad75ffe10a8baa1899045ad6f1f656a61baeae))
* opt in local model discovery and standardize pin hashing ([#929](https://github.com/roryford/ManifoldKit/issues/929)) ([7d6f2e3](https://github.com/roryford/ManifoldKit/commit/7d6f2e3517dfa7ab99df6d985974227b954f8349))
* persist MCP OAuth tokens in Keychain ([#926](https://github.com/roryford/ManifoldKit/issues/926)) ([6799e3d](https://github.com/roryford/ManifoldKit/commit/6799e3dfd62f8307ebb9e3aa137153b0022caef5))
...
* pin .package(name:) on tier-1 cold-start script for worktree portability ([#1102](https://github.com/roryford/ManifoldKit/issues/1102)) ([35d7516](https://github.com/roryford/ManifoldKit/commit/35d751633ccfd3e60193211bf93ea6273e5017b9))
* prefer smallest GGUF test model ([#1044](https://github.com/roryford/ManifoldKit/issues/1044)) ([52d2191](https://github.com/roryford/ManifoldKit/commit/52d2191504eb119e9292af35c4e992078f4de34c))
* regenerate Package.resolved — sync originHash + default-trait deps after T1.5 ([0b14ef2](https://github.com/roryford/ManifoldKit/commit/0b14ef2c3792c5ecd64cdfc6eee3e56e79ad558b))
* remove duplicate maxMCPToolNameBytes/maxMCPToolDescriptionBytes declarations ([#1267](https://github.com/roryford/ManifoldKit/issues/1267)) ([512f4b3](https://github.com/roryford/ManifoldKit/commit/512f4b38c67d24410711c4b92d0b044107c613b0))
* remove duplicate maxMCPToolNameBytes/maxMCPToolDescriptionBytes declarations in ManifoldConfiguration ([#1264](https://github.com/roryford/ManifoldKit/issues/1264)) ([5317ad4](https://github.com/roryford/ManifoldKit/commit/5317ad44a4dedd4226b1481f4f2142f1b5aafe92))
* remove fuzz dependency on test support ([#1124](https://github.com/roryford/ManifoldKit/issues/1124)) ([30bae02](https://github.com/roryford/ManifoldKit/commit/30bae0271cf1039c40a2eeea43264d78687a0ae4))
* repair demo scenario tool flows ([#1057](https://github.com/roryford/ManifoldKit/issues/1057)) ([6c4c4cb](https://github.com/roryford/ManifoldKit/commit/6c4c4cba8177126cb0752bd0f8e22dbcb024be75))
...
* require approval for AppIntent tools ([#921](https://github.com/roryford/ManifoldKit/issues/921)) ([73eed19](https://github.com/roryford/ManifoldKit/commit/73eed19c1d454c1d54578fbc29d1b369960602c4))
* reset search scope and clear immediately when query is emptied ([92c9676](https://github.com/roryford/ManifoldKit/commit/92c96763d42b5d45fc2c05eb1bbd7c7871467096))
* resolve 5 test failures exposed by full-trait suite run ([bfbcf66](https://github.com/roryford/ManifoldKit/commit/bfbcf660a4405cb29cc46b6993c70a458d8aa73a))
* resolve Swift 6 @Sendable closure and mlx-swift-examples iOS platform conflict ([#1068](https://github.com/roryford/ManifoldKit/issues/1068)) ([ba88378](https://github.com/roryford/ManifoldKit/commit/ba88378bc79f4f287f0beae727bc74d31fd2a74b))
* restore maxMCPToolNameBytes/maxMCPToolDescriptionBytes after over-aggressive dedup ([#1268](https://github.com/roryford/ManifoldKit/issues/1268)) ([9398b8b](https://github.com/roryford/ManifoldKit/commit/9398b8badd6264a11e7a7a2b1ae380355e70ed0f))
* revalidate MCP network destinations ([#925](https://github.com/roryford/ManifoldKit/issues/925)) ([43f915b](https://github.com/roryford/ManifoldKit/commit/43f915bacbc520acb93af770b18150b700b0e537))
* revert llama.swift pin — CI tree-read failure on 2.9050.0 ([27027f8](https://github.com/roryford/ManifoldKit/commit/27027f8a1b3ced6a5fdc9e6efcd8b16f05f0cb9e))
* rewrite 0.17.1 changelog ([#1058](https://github.com/roryford/ManifoldKit/issues/1058)) ([d18c01a](https://github.com/roryford/ManifoldKit/commit/d18c01a425d4f5f453b1f27f65e98651c1ba048b))
* rewrite 0.17.1 changelog bullets to preferred style ([#1062](https://github.com/roryford/ManifoldKit/issues/1062)) ([57e0edd](https://github.com/roryford/ManifoldKit/commit/57e0eddcb7176ae9b4f015882a5e078c9dcff923))
* route MCP networking through shared boundary ([#923](https://github.com/roryford/ManifoldKit/issues/923)) ([3234a24](https://github.com/roryford/ManifoldKit/commit/3234a2446a8a1c262a312c8a3caf8c4b16675fbc))
* **runtime:** persist session B turn after switch-cancel-resend ([#1005](https://github.com/roryford/ManifoldKit/issues/1005)) ([e1a8e56](https://github.com/roryford/ManifoldKit/commit/e1a8e56c133843acc246392ef0de7ec8a7b1ca3a))
* scope default model storage per app ([#1126](https://github.com/roryford/ManifoldKit/issues/1126)) ([694df45](https://github.com/roryford/ManifoldKit/commit/694df45ed34bc9f4d5e2d8fe0a082fd620c08800))
* **security:** redirect-cap delegate, credential strip on cross-origin redirects, HMAC resume blobs, MCP sanitizer CSI/OSC/DCS ([#1138](https://github.com/roryford/ManifoldKit/issues/1138)) ([6dc905f](https://github.com/roryford/ManifoldKit/commit/6dc905f27db4ae8b795bee90254427e6c5b7dce6))
* **security:** strip all special tokens in PromptTemplate.sanitize regardless of active template ([#1334](https://github.com/roryford/ManifoldKit/issues/1334)) ([2b3386d](https://github.com/roryford/ManifoldKit/commit/2b3386da00e0123044db80ed29f3433fce279cc0))
* stop backend generation on SSE disconnect ([08880b2](https://github.com/roryford/ManifoldKit/commit/08880b234fd374a040fdf97fd108af7d86343476))
* stop server generation on disconnect ([#1123](https://github.com/roryford/ManifoldKit/issues/1123)) ([55c9518](https://github.com/roryford/ManifoldKit/commit/55c95183793b7c21f15b7d71276782ab8b529d42))
* **test-infra:** prevent absolute-path model override from falling back to discovery ([#1182](https://github.com/roryford/ManifoldKit/issues/1182)) ([fc46952](https://github.com/roryford/ManifoldKit/commit/fc4695268ed6f9cd4979ee674032fddf0c88467c))
* **test:** allowlist MLX tool-calling try? probes in SilentCatchAuditTest ([#743](https://github.com/roryford/ManifoldKit/issues/743)) ([46eae2e](https://github.com/roryford/ManifoldKit/commit/46eae2ef8081685434fdc8ecdc4cb9dd36c82aaa))
* **test:** chat-template prompt in EOG regression test ([#519](https://github.com/roryford/ManifoldKit/issues/519)) — fixes Qwen3 EOG detection ([#984](https://github.com/roryford/ManifoldKit/issues/984)) ([587de79](https://github.com/roryford/ManifoldKit/commit/587de798f6254d44f97afe026904843461347e5d)), closes [#968](https://github.com/roryford/ManifoldKit/issues/968)
* **test:** correct trait gate on CloudEndpointSelectionIntegrationTests ([#777](https://github.com/roryford/ManifoldKit/issues/777)) ([6da7b44](https://github.com/roryford/ManifoldKit/commit/6da7b44e9a933c477b445e60686f37e4932bd40a))
* **test:** declare BaseChatTools dependency on BaseChatE2ETests ([#784](https://github.com/roryford/ManifoldKit/issues/784)) ([1babe9f](https://github.com/roryford/ManifoldKit/commit/1babe9fde82764aa1795634d001b9fc16fee8d6e))
* **test:** deflake ConversationRuntime back-to-back token-usage assertion ([#1130](https://github.com/roryford/ManifoldKit/issues/1130)) ([fa16dfd](https://github.com/roryford/ManifoldKit/commit/fa16dfdf94c58cbcfb11ba14b26ff41a1738925c))
* **test:** disable thinking in LlamaE2ETests basic real-inference suite ([#1137](https://github.com/roryford/ManifoldKit/issues/1137)) ([1bee94b](https://github.com/roryford/ManifoldKit/commit/1bee94b09138472de9cae90d077060c214d368be))
* **test:** handle diagnosticThrottle in trait-gated switch statements ([#772](https://github.com/roryford/ManifoldKit/issues/772)) ([5a0e82d](https://github.com/roryford/ManifoldKit/commit/5a0e82d729bd682c7837638a9d51c7ea9ca34a2b))
* **test:** inject UserDefaults into BackgroundDownloadManager to remove --parallel flake ([#734](https://github.com/roryford/ManifoldKit/issues/734)) ([8a81196](https://github.com/roryford/ManifoldKit/commit/8a8119606da07de62264b9c343e68479a80b7b24))
...
* **tests:** drain pre-fired hook calls to unblock CI ([#1322](https://github.com/roryford/ManifoldKit/issues/1322)) ([6142aac](https://github.com/roryford/ManifoldKit/commit/6142aac11b779596256324ad2543cfb958408768))
* **tests:** expand LlamaEmbeddingBackend class list in isolation script + rename BCK_ env vars ([#1173](https://github.com/roryford/ManifoldKit/issues/1173)) ([4576322](https://github.com/roryford/ManifoldKit/commit/45763226d6f455ea5dd281392c58c36fe941bb60))
* **tests:** handle prefillProgress in OllamaToolCallLiveReplayTests switch ([#808](https://github.com/roryford/ManifoldKit/issues/808)) ([4057ed1](https://github.com/roryford/ManifoldKit/commit/4057ed16dd95101e025888572c546701bd7134cb))
...
* **tests:** make SessionDiscardOrderingTests skip actually take effect ([#1307](https://github.com/roryford/ManifoldKit/issues/1307)) ([9474434](https://github.com/roryford/ManifoldKit/commit/9474434a6ef0eedb9648cd16613b19cd3941313f))
* **test:** stabilise macOS XCUITest suite ([#716](https://github.com/roryford/ManifoldKit/issues/716)) ([c5d7577](https://github.com/roryford/ManifoldKit/commit/c5d7577ee45f78257a1f2aefee481921fcc222d9))
* **test:** stabilise test-suite — grammar SIGABRT, KV leak, concurrency race, snapshot trait gap ([#760](https://github.com/roryford/ManifoldKit/issues/760)) ([cf3e603](https://github.com/roryford/ManifoldKit/commit/cf3e6030fb17bc1179cda4a97780c268f24ced95))
* **test:** tighten system-prompt-change KV reuse assertion ([#1048](https://github.com/roryford/ManifoldKit/issues/1048)) ([3127b42](https://github.com/roryford/ManifoldKit/commit/3127b42265d0327daa5c4ff107af1870292e24fd))
* update README install pin to match version.txt (0.27.0) ([#1263](https://github.com/roryford/ManifoldKit/issues/1263)) ([93b7e99](https://github.com/roryford/ManifoldKit/commit/93b7e99b56ce47b08c099faa802febfb162ca247))
* validate importModel filename and use symlink-resolving containment checks ([#1255](https://github.com/roryford/ManifoldKit/issues/1255)) ([8c84b11](https://github.com/roryford/ManifoldKit/commit/8c84b11d4a118ca533098724ced38953543bca54))
* wire appearance mode, AFM model label, and toolbar overflow ([faba071](https://github.com/roryford/ManifoldKit/commit/faba071b3dff43c175f9405fda12da2b7d149715))
* wire MCPClientConfiguration.requestTimeout to MCPSession and cap MCP redirect chains to 3 hops ([#1258](https://github.com/roryford/ManifoldKit/issues/1258)) ([d65d4b5](https://github.com/roryford/ManifoldKit/commit/d65d4b524085f177267dab648d236dcd4c1052d5))


### Performance Improvements

* **build:** trait-gate @ToolSchema macro behind Macros trait ([#957](https://github.com/roryford/ManifoldKit/issues/957)) ([ae382eb](https://github.com/roryford/ManifoldKit/commit/ae382eb185d9a0e12a04fd6a9e4e7cbeadfd3cbc))
* **ci:** batch security-audits' default-trait invocations ([#954](https://github.com/roryford/ManifoldKit/issues/954)) ([adfd4d6](https://github.com/roryford/ManifoldKit/commit/adfd4d620b6a3ca6f32c745365494002914911a1))
* **ci:** cap per-test execution time so a hung test fails fast instead of starving the job ([#1311](https://github.com/roryford/ManifoldKit/issues/1311)) ([47ff3ac](https://github.com/roryford/ManifoldKit/commit/47ff3ac45fe5324073cd5a1c6bd90949a0a7f692))
* **ci:** consolidate 7 ubuntu lint jobs into one runner ([#956](https://github.com/roryford/ManifoldKit/issues/956)) ([3698f4a](https://github.com/roryford/ManifoldKit/commit/3698f4aeebe7aefc39efd15fed72d6031f501fc6))
* **ci:** consolidate test runs and tighten path filters ([#756](https://github.com/roryford/ManifoldKit/issues/756)) ([4b6003f](https://github.com/roryford/ManifoldKit/commit/4b6003f4ce008f787e1d6fe717dd0fe8cc229f72))
* **ci:** move build-modes.full to nightly + workflow_dispatch ([#955](https://github.com/roryford/ManifoldKit/issues/955)) ([cba0c60](https://github.com/roryford/ManifoldKit/commit/cba0c60de75d7bf6936442f9669ecb9c271fd1e0))
...
* **ci:** move slow audit + perf baselines to nightly tier ([#803](https://github.com/roryford/ManifoldKit/issues/803)) ([000d198](https://github.com/roryford/ManifoldKit/commit/000d1989827cdb8714ecf55e036ad5703cef186e))
* **ci:** revert .build/debug cache spike — no measurable wins ([#953](https://github.com/roryford/ManifoldKit/issues/953)) ([#1036](https://github.com/roryford/ManifoldKit/issues/1036)) ([400c099](https://github.com/roryford/ManifoldKit/commit/400c09948947aba5d1f3e398deb473ed60ce5e14))
...
* **ci:** skip Package.resolved verify step when deps unchanged ([#751](https://github.com/roryford/ManifoldKit/issues/751)) ([3b33b4a](https://github.com/roryford/ManifoldKit/commit/3b33b4a3bc1043f44586474969030e0cae59e921))
* **ci:** spike .build/debug caching with mtime fix (Lever C of [#953](https://github.com/roryford/ManifoldKit/issues/953)) ([#961](https://github.com/roryford/ManifoldKit/issues/961)) ([3fcca3a](https://github.com/roryford/ManifoldKit/commit/3fcca3a43d77e3b2242a20a2c88687e38c7d3c0a))
* **mlx:** yield briefly every N tokens to prevent WindowServer starvation ([#766](https://github.com/roryford/ManifoldKit/issues/766)) ([169deeb](https://github.com/roryford/ManifoldKit/commit/169deebc8b9f4250c847212dd2612c608aeb7c0a))
* **mlx:** yield during long token generation ([#1032](https://github.com/roryford/ManifoldKit/issues/1032)) ([3c823af](https://github.com/roryford/ManifoldKit/commit/3c823afcda846c5e150cbd01530736305e8a358d))
* spike SwiftPM debug cache reuse in CI ([#1045](https://github.com/roryford/ManifoldKit/issues/1045)) ([3cb46d1](https://github.com/roryford/ManifoldKit/commit/3cb46d12bcec124fc14f9d6f26b0eff03c21ec5d))
* **test:** enable swift test --parallel for full XCTest batch ([#996](https://github.com/roryford/ManifoldKit/issues/996)) ([160860a](https://github.com/roryford/ManifoldKit/commit/160860ae555a83c895de36c437d4608fc3557ff8))


### Code Refactoring

* make persistence and command APIs async throws (phase 1.0) ([#883](https://github.com/roryford/ManifoldKit/issues/883)) ([dc5d19c](https://github.com/roryford/ManifoldKit/commit/dc5d19ce5b8b362b482ca03647ebc9ebeaa1aa99))
