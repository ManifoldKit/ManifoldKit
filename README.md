...
```swift
.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.28.0")
```
...
- Update SPM dependencies: `.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.28.0")`
