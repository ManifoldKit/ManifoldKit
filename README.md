...
.package(
    ...
    from: "0.35.0" // x-release-please-version
)
```
...
- Update SPM dependencies to `.package(url: "https://github.com/roryford/ManifoldKit.git", ...)` with `from: "0.35.0"` <!-- x-release-please-version -->
