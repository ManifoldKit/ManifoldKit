...
```text
.package(url: "https://github.com/ManifoldKit/ManifoldKit.git", from: "0.79.1"), // x-release-please-version
...
- Update SPM dependencies to `.package(url: "https://github.com/ManifoldKit/ManifoldKit.git", ...)` with `from: "0.79.1"` <!-- x-release-please-version -->
