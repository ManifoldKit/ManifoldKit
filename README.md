...
```swift
.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.31.0") // x-release-please-version
```
...
- Update SPM dependencies: `.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.31.0")` <!-- x-release-please-version -->
