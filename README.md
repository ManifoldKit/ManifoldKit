...
```swift
.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.25.2")
```
...
- Update SPM dependencies: `.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.25.2")`
