...
```swift
.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.30.0") // x-release-please-version
```
...
.package(
    ...
    from: "0.30.0", // x-release-please-version
    traits: [
        .trait(name: "MLX"),
        .trait(name: "Llama"),
...
- Update SPM dependencies: `.package(url: "https://github.com/roryford/ManifoldKit.git", from: "0.30.0")` <!-- x-release-please-version -->
