...
The transport rejects an empty token or one containing ASCII whitespace or control characters with `MCPHostTransportError.invalidAuthorizationToken`. Add that case to any exhaustive switches over the transport error enum.
