...
- The backend families (`ManifoldFoundation`, `ManifoldOllama`,
  `ManifoldCloudSaaS`) are the concrete Foundation and cloud backends
  (always compiled into core since v0.48; the `ManifoldBackends` umbrella that
  re-exported them was retired in P7). The MLX and llama.cpp families live in
